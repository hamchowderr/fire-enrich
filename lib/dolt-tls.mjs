 ...
 * the handshake, before any credentials are sent, so it is the recommended
 * `DOLT_HOST` (docs/dolt-setup.md). The IP path stays for deployments whose
 * `DOLT_HOST` is an IP address.
 *
